...
class TabsView: UIView{
    lazy var collectionView: UICollectionView = {
        ...
        // De esta forma el collection view tendra el scroll horizontal
...
extension TabsView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configCell(options: options[indexPath.item])
        return cell
    }
    
    //metodo para enlazar pantallas con el tabview
